-- DB user
-- SPECIFY DB USER AND PASSWORD BEFORE RUNNING THE SCRIPT
-- DROP USER IF EXISTS 'username';
-- CREATE USER 'username' IDENTIFIED BY 'password';

-- APPLICATION DATABASE
DROP DATABASE IF EXISTS billSysData;
CREATE DATABASE billSysData;

-- GRANTS ALL PRIVILEGE ON APPLICATION DATABASE TO DB USER
-- GRANT ALL ON billSysData.* TO 'username';
-- FLUSH PRIVILEGES;
