        ...
        if(array_key_exists("passwordOld",$_POST)){
          ...
          if(array_key_exists("passwordNew",$_POST)){
            ...
            if($_SESSION["type"]==="client"){
              ...
              if(1 == $this->db->query("SELECT COUNT(clientID) FROM client WHERE username='".$_SESSION["username"]."',password=SHA1('".$_POST["passwordOld"]."')")->row_array()["COUNT(clientID)"]){
            ...
            if(($_SESSION["type"]==="admin")||($_SESSION["type"]==="technician")){
              ...
              if(1 == $this->db->query("SELECT COUNT(adminID) FROM adminAcc WHERE username='".$_SESSION["username"]."',password=SHA1('".$_POST["passwordOld"]."')")->row_array()["COUNT(adminID)"]){
            ...
            if($_SESSION["type"]==="superadmin"){
              ...
              if(1 == $this->db->query("SELECT COUNT(superAdminID) FROM superAdmin WHERE username='".$_SESSION["username"]."',password=SHA1('".$_POST["passwordOld"]."')")->row_array()["COUNT(superAdminID)"]){
