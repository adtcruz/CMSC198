...
class View_job_requests_model extends CI_Model
{
	...
	public function getJobActions($currentRow,$userID)
	{
		...
		if($jobStatus === "PENDING"){
			...
			if($_SESSION["type"]==="superadmin"){
				$actions = "<a class=\"btn-floating btn tooltipped waves-effect waves-light green\" data-position=\"left\" data-delay=\"50\" data-tooltip=\"Add job to schedule\" onclick=\"openAddToSched('".base_url()."',".$jobID.");\"><i class=\"material-icons\">assignment</i></a>&nbsp;&nbsp;";
